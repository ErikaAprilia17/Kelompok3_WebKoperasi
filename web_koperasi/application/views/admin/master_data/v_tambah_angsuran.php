          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Tambah Jenis Angsuran</li>
              </ol>
            </nav>
          </div>
             <div class="card">
             <div class="card-body">
            <form class="forms-sample" action="<?php echo base_url()?>admin/master_data/lama_angsuran/insert" method="post">
                    
                    <div class="form-group">
                      <label for="lama_angsuran"><b>Lama Angsuran (Bulan)</b></label>
                      <input type="text" class="form-control" name="lama_angsuran" id="lama_angsuran" placeholder="lama_angsuran">
                    </div>
                    <div class="form-group">
